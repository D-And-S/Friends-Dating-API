...
namespace Friends_Date_API.SignalR
{
    ...
    public class MessageHub : Hub
    {
        ...
        public MessageHub(IHubContext<PresenceHub> presenceHub, PresenceTracker tracker)
        {
            ...
            _unitOfWork = (IUnitOfWork)ApplicationServiceExtension.serviceProvider.GetRequiredService(typeof(IUnitOfWork));
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            */
            ...
            // in getMessageTHread when recipent see message it it will mark as read
            // in here we will track and changes the database
